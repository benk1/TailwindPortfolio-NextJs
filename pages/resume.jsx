...
const Resume = () => {
	...
	return (
		<>
			...
			<main
				id="main"
				className="max-w-[940px] mx-auto p-2 pt-[50px] md:pt-[120px] px-4 "
			>
				<header>
					<h1 className="font-bold text-blue-700 ">Curriculum Vitae - CV</h1>
					<div className="bg-[#d0d4d6] my-4 p-4 w-full flex justify-between items-center">
						...
						<a
							...
							target="_blank"
							rel="noreferrer"
							aria-label="Open Bernard Kakengi LinkedIn profile (opens in a new tab)"
							className="inline-flex items-center justify-center rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E07400]"
						>
				...
				<section aria-label="Summary">
					<p>
						...
						background in modern front-end technologies. Recently, I worked on
						an AI-powered web platform (<b>twoday's AI Agent</b> solution -{' '}
						...
						tools and technologies. I am known for staying positive under
						pressure and always maintain a positive attitude. My experience has
						helped me develop strong communication skills and the ability to
						work in different environments. I enjoy creating user-friendly and
						innovative applications while continuously improving my skills.
					</p>
				</section>

				<section className="py-4 text-center" aria-labelledby="skills-title">
					<h2 id="skills-title" className="underline text-[18px] py-2">
						Skills
					</h2>
					<p className="py-2">
				...
				<section aria-labelledby="experience-title">
					<h2
						id="experience-title"
						className="text-center underline text-[18px] py-4"
					>
						Professional Experience
					</h2>

					<section className="py-6" aria-labelledby="twoday-title">
						<p id="twoday-title" className="italic">
						...
						<p className="py-1 italic">
							...
							multiple clients to meet their requirements under given
							deadlines{' '}
						</p>
						<ul className="py-1 leading-relaxed list-disc list-outside px-7">
							<li>
								<li>
									<b>twoday AI Agent</b> - Developed twoday AI-driven web
									platform with interactive chat solutions focusing on seamless
									user interactions and efficient data management. Built
									responsive user interfaces that act as a company's personal
									...
									React 19, Next.js 14, TypeScript, Vite, MUI (Material UI),
									React Query (@tanstack/react-query), REST APIs, GPT (LLM){' '}
									<br />
									<span className="italic ">
										<b>Backend Technologies used :</b>
									</span>{' '}
									ASP.NET Core 8, C#, Entity Framework Core, SQL Server,
									PostgreSQL, Azure OpenAI SDK, Microsoft Cognitive Services,
									JWT Authentication, Serilog, Lucene.NET, PuppeteerSharp,
									MailKit, Swagger (Swashbuckle), REST APIs
								</li>
								...
								<li>
									...
									<br />
									<span className="italic ">
										<b>Back end Technologies used :</b>
									</span>{' '}
									Python Flask, AWS Lambda, Serverless Framework, API Gateway,
									S3, Cognito, DynamoDB, Snowflake, Elasticsearch,
									CloudFormation, Jenkins CI/CD
								</li>
							</li>

							<li>
								<b>Kotoutumisen-Tukena</b> - I worked on improving and
								customizing a Liferay 7.4-based platform aimed at supporting
								immigrant integration in Finland, My focus was on front-end
								development using React, FreeMarker, and Liferay CMS. I ensured
								the design matched Figma specs and followed accessibility
								standards, making the site more user-friendly for everyone.
								<br />{' '}
								<span className="italic ">
									{' '}
									<b>Front-end Technologies used :</b>
								...
								Java, Liferay 7.4 (OSGi-based architecture), Service Builder
								(for persistence), REST APIs (via Liferay REST Builder), Gradle,
								MySQL, JSP/FreeMarker for custom templates, Liferay Role &
								Permission Management
							</li>
						</ul>
					</section>

					<section className="py-6" aria-labelledby="bearit-title">
						<p id="bearit-title" className="italic">
							<span className="italic font-bold">BEARIT Oy</span>
							<span className="px-2">|</span>Finland, Helsinki
						</p>
						<p className="py-1 italic">
							Web Developer (January 2022 August 2022 ) <br />
						...
						<ul className="py-1 leading-relaxed list-disc list-outside px-7">
							<li>
								...
								enabling coaches to monitor player progress, set goals, and
								assess capabilities based on game and training data. Designed
								and implemented an intuitive user interface for seamless
								navigation and usability. I collaborated with professional
								coaches to gather insights and translate their needs into
								functional application features. Worked closely with the
								cloud-based backend team to ensure smooth data integration and
							...
							<br />
							<li>
								<b>Oskari Project</b> - Contributed to the development of
								Oskari, a survey system designed for industry clients as part of
								BearIT’s internal project. I Assisted in building user-friendly
								interfaces to enhance the survey experience and improve data
								collection efficiency. Worked closely with the development team
								to implement responsive design and industry-specific features
								for better usability.
							</li>
						</ul>
					</section>

					<section className="py-6" aria-labelledby="integrify-title">
						<p id="integrify-title" className="italic">
					...
					<section className="py-6" aria-labelledby="sibesonke-title">
						<p id="sibesonke-title" className="italic">
						...
						<ul className="py-1 leading-relaxed list-disc list-outside px-7">
							...
							<li>
								Worked with Active Record ORM to manipulate databases
								efficiently.
							</li>
							<li>
								Performed database management and optimization using MySQL.
							</li>
							<li>
						...
						<section className="py-6" aria-labelledby="sask-title">
							<p id="sask-title" className="italic">
					...
					<section className="py-6" aria-labelledby="languages-title">
						<p id="languages-title" className="italic">
					...
					<section className="py-6" aria-labelledby="education-title">
						<p id="education-title" className="italic">
